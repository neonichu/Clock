...
func tm_struct(year: Int = 0, month: Int = 0, day: Int = 0,
               hour: Int = 0, minute: Int = 0, second: Int = 0,
               timeZoneOffset: TimeInterval = 0) -> tm {
...
class TMStructTests: XCTestCase {
    ...
    func testCanParseDatesWithoutSeconds() {
        XCTAssertEqual(ISO8601.parse("1971-02-03T04:05Z"), tm_struct(year: 1971, month: 2, day: 3, hour: 4, minute: 5))
    }

    func testResilienceAgainstY2KBugs() {
        XCTAssertEqual(ISO8601.parse("2058-02-20T18:29:11.100Z"), tm_struct(year: 2058, month: 2, day: 20, hour: 18, minute: 29, second: 11))
        XCTAssertEqual(ISO8601.parse("3001-01-01T08:00:00.000Z"), tm_struct(year: 3001, month: 1, day: 1, hour: 8))
    }
}
